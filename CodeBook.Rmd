...
training[7352 X 563]    Training data set adding subject and activity info
test[2947 X 563]    Test data set adding subject and activity info
complete[10299 X 563]    Traing and test data set merged (since there is no overlap, size of the merged data is simply the sum of the two)
tidydata[10299 X 81]   Extrating only measurements of mean and standard deviation
tidy_mean[180 X 81]    Average of each variable for each activity and each subject
